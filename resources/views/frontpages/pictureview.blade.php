...
@section('image',  $photo->thumbnail)
@section('description',  'sexy picture' )
@section('imagealt',  '' )
...
<div class="main-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <h4 class="mt-3">{{ $photo->title }}</h4>
            
            <div class="d-flex justify-content-between align-items-center mt-2 mb-4">
                <h6 class="mb-0">{{ $photo->channel }}</h6>
    ...
    <div class="row">
        ...
        <a href="{{ route('photo.view', $related->slug) }}" class="gallery-link">
